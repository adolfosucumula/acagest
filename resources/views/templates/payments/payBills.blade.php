      ...
      <h5 class="text-muted">@isset($subtitle) {{$subtitle}} @endisset</h5>
        ...
        <div class="row">
          ...
          <div class="input-group">
            <input type="text" class="form-control" name="searchStudent" placeholder="Pesquisar estudante pelo nif e nome">
            <div class="input-group-append">
              <button type="submit" class="btn btn-primary"><span data-feather="search"></span></button>
            </div>
          </div>
          </div>
          </div>
