...
Route::get('/bills', 'BillController@index')->name('bill');
Route::get('/bills/add', 'BillController@create')->name('bill.new');
Route::post('/bills/insert', 'BillController@store')->name('bill.add');