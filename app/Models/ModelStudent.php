...
class ModelStudent extends Model
{
    ...
    public function relPeople(){
        return $this->hasOne('App\Models\ModelPeoples','id_people','people_id');
    }
    ...
    public function relContacts(){
        return $this->hasMany('App\Models\ModelContacts','id_contact','contact_id');
    }
    public function relBills(){
        return $this->hasMany('App\Models\ModelBill','student_id','id_student');
    }
}
